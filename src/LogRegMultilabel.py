...
def main():
    ...
    print(f"\nBest threshold: {best_thresh}, Best score: {best_score}")
    ...
    save_path = CONFIG.get("OUTPUT_DIR", "./output")
    os.makedirs(save_path, exist_ok=True)

    streaming_inference_logreg(
        model, test_seqs, CONFIG,
        best_thresh, mlb, restricted_parents,
